! function () {
	...
	var g = typeof self === 'undefined' ? global : self,
		...
		esobjs = {
			...
			'object': ['string', 'number', 'boolean', 'symbol', 'bigint', 'date', 'regexp', 'error', 'promise', 'map', 'weakmap', 'set', 'weakset', 'proxy', 'generator', 'asyncgenerator', 'dataview', 'arraybuffer', 'sharedarraybuffer'].concat(arrays)
		},
